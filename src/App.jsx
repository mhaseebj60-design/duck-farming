...
function App() {
  ...
  async function checkCurrentUser() {
    try {
      ...
      console.error("Could not check current user:", error);
      setUser(null);
      setIsAdminUser(false);
      setCheckingAdmin(false);
    }
  ...
  async function handleAdminLogin(event) {
    ...
    if (!loggedInUser) {
      setLoginError("Login failed. User account was not returned.");
      setCheckingAdmin(false);
      return;
    }
    ...
    const admin = await checkAdminRole(loggedInUser);
    ...
    if (!admin) {
      ...
      setLoginError(
        "This account is not an admin. Ask an administrator to set your profile role to admin."
      );
      ...
      <section className="hero-section">
        <div className="hero-text">
          ...
          <h1>
            ...
            <br />
            <span>
              Earn eggs every 24 hours.
            </span>
          </h1>

          <p>
            Buy a premium duck, submit payment proof,
            and let the system track its lifetime and
            egg production.
          </p>
          ...
          <div className="hero-buttons">
            <button
              ...
              onClick={() =>
                alert(
                  "Farming purchase flow can be connected next."
                )
              }
            >
              🛒 Start Farming
            ...
            <button
              ...
              onClick={() =>
                alert(
                  "Customer login can be connected next."
                )
              }
            >
              Customer Login
      ...
      <section className="product-section">
        ...
        <div className="product-card">
          ...
          <div className="product-info">
            ...
            <p>
              One duck · {settings.lifetime}-day
              lifetime · {settings.eggs} egg every
              24 hours
            </p>
          </div>
          ...
          <div className="product-price">
            ...
            <strong>
              Rs{" "}
              {Number(settings.price).toLocaleString()}
            </strong>
      ...
      <section className="info-section">
        ...
        <div className="info-grid">
          <div>
            ...
            <p>
              Choose the available premium duck
              package.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Send your payment proof for admin
              review.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Your duck produces {settings.eggs} egg
              every 24 hours during its{" "}
    ...
    <main className="admin-page">
      <div className="admin-heading">
        <div>
          ...
          <p>
            Manage your Duck Farming website
            from one place.
          </p>
        </div>
      ...
      <section className="admin-card">
        <div className="admin-card-heading">
          <div>
            ...
            <p>
              Add customers and manage their
              duck and egg balances.
            </p>
          </div>
        </div>
      ...
      <section className="admin-card warning-card">
        ...
        <p>
          The settings, customers and payments
          in this version are saved in this
          browser using localStorage. They are
          useful for testing the dashboard, but
          they are not yet shared with other
          customers.
        </p>

        <p>
          For a real production system, these
          records should be moved into Supabase
          tables with proper admin permissions
